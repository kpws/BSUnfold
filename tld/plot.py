...
def plot(name='default'):
	...
	m0=Li8u/Na/1e3
	me=9.10938188e-31
	De=(Li7u+nu-Li8u)/1e3/Na*c**2
	#E0=(np.sqrt(2*m0*De+c**2*m0**2)-c*m0)**2/(2*m0)*GeVPerJ
	Ei=520.2e3/Na*2
	E0=(np.sqrt(2)*np.sqrt(De*m0+c**2*m0**2+np.sqrt(c**2*m0**2*(c**2*me**2+2*De*m0+c**2*m0**2))))*GeVPerJ
	pl.plot(E,[E0 for e in E],label='Mass difference between Li7 + n and Li8 + $\gamma$')
	pl.legend(loc=4)
